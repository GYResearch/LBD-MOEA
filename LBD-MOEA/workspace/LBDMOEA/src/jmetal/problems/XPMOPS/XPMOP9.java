...
/** 
 * Class representing problem PMOP9: g_1, l_1, k_6, h_3
 * 
 ...
 */
public class XPMOP9 extends Problem {   
...
//	private boolean LINKAGE = true;
  ...
  */
  public XPMOP9(String solutionType) throws ClassNotFoundException {
...
//		 this(solutionType, 14,5);//(7,3)
   ...
   */
  public XPMOP9(String solutionType, 
  ...
  */    
  public void evaluate(Solution solution) throws JMException {
	...
	k_ = k_ / (numberOfObjectives_ - 1); //  k_6
    ...
    for (int i = 0; i < numberOfObjectives_; i++) {// g_1, k_6, l1, h3
