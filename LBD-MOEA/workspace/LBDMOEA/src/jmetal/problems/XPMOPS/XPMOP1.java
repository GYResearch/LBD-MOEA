 ...
 */
public class XPMOP1 extends Problem {
//	private boolean LINKAGE = true;
	 ...
	 */
	public XPMOP1(String solutionType) throws ClassNotFoundException {
//		 this(solutionType, 12,3);//n=m+k-1 k=10
//		 this(solutionType, 14,5);// 
		 this(solutionType, 17,8);// 
//		 this(solutionType, 14,10);
//		 this(solutionType, 7,2);
	 ...
	 */
	public XPMOP1(String solutionType, Integer numberOfVariables, Integer numberOfObjectives)
			throws ClassNotFoundException {
...
//		g=0; // to get the solutions on the PoF.
		...
		double k_ = 1.0;
		int A = 4, B = 1, S = -1; // in knee function
		int P = 1; // in underlying shape function
		...
		k_ = Math.log(k_ / ((numberOfObjectives_ - 1))); //
