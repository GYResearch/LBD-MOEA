 ...
 */
public class XPMOP12 extends Problem {
...
//	private boolean LINKAGE = true;
	 ...
	 */
	public XPMOP12(String solutionType) throws ClassNotFoundException {
...
//			 this(solutionType, 14,5);//(7,3)
	 ...
	 */
	public XPMOP12(String solutionType, Integer numberOfVariables, Integer numberOfObjectives)
			throws ClassNotFoundException {
...
//		g8=0; // to obtain solutions on the PoF
	    ...
	    k_ =Math.pow(k_ / (numberOfObjectives_ - 1),2);// knee function k_3
