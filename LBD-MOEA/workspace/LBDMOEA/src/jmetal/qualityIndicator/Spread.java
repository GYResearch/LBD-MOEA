...
/**
 * This class implements the spread quality indicator. It can be used also as
 * command line program just by typing:
...
public class Spread {
	...
	static jmetal.qualityIndicator.util.MetricsUtil utils_;// utils_ is used to
															// access to
	...
	public double spread(double[][] front, double[][] trueParetoFront,
		...
		// the metric)
		double df = utils_.distance(normalizedFront[0],
				normalizedParetoFront[0]);
		double dl = utils_.distance(
				normalizedFront[normalizedFront.length - 1],
	...
	public static void main(String args[]) {
		if (args.length < 2) {
			System.err
					.println("Spread::Main: Error using Spread. Usage: \n java "
