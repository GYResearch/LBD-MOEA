 ...
 */
public class KneeOrientedRanking {
   ...
   */
  public KneeDominanceComparator dominance_ = new KneeDominanceComparator(); //  
   ...
   */       
  public KneeOrientedRanking(SolutionSet solutionSet,double[][] extreme, double gama) {        
 ...
 */
  public KneeOrientedRanking(SolutionSet solutionSet, double[][] extre, double gama, int[] weight) {
	    ...
	    // of individuals that dominate me
	      ...
	      for (int q = 0; q < solutionSet_.size(); q++) {
	        ...
	        if (flagDominate == 0) {
	           weightp = weight[p];
	           weightq = weight[q];
	          flagDominate =dominance_.compare(solutionSet.get(p),solutionSet.get(q), extre, gama, weightp,weightq); // extreme                           
	        }
	        if (flagDominate == -1) {
