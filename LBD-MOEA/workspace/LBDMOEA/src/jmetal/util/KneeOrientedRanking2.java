...
import jmetal.util.comparators.KneeDominanceComparator;
import jmetal.util.comparators.KneeDominanceComparator2;
 ...
 */
public class KneeOrientedRanking2 {
   ...
   */
  public KneeDominanceComparator2 dominance_ = new KneeDominanceComparator2(); //  
   ...
   */       
  public KneeOrientedRanking2(SolutionSet solutionSet,double[][] extreme, double gama) {        
    System.out.println("-- Selection by KneeOrientedRanking --");    
  } // Ranking
 ...
 * @param extre
 * @param gama
 * @param weight: the index of the solutions
 */
  public KneeOrientedRanking2(SolutionSet solutionSet, double[][] extre, double gama, int[] weight, int[] countindex2, int eva, int maxeva) {
	// TODO Auto-generated constructor stub
	  solutionSet_ = solutionSet ;
	    ...
	    // two extreme points (ideal point and nadir point)
	    ...
	    // of individuals that dominate me
	      ...
	      for (int q = 0; q < solutionSet_.size(); q++) {
	        ...
	        if (flagDominate == 0) {
	           weightp = weight[p];
	           weightq = weight[q];
	          flagDominate =dominance_.compare(solutionSet.get(p),solutionSet.get(q), extre, gama, weightp,weightq, countindex2, eva, maxeva, solutionSet.size()); // extreme                           
	        }
	        if (flagDominate == -1) {
